...
public class MockLocationProviderManager {
     ...
     * @param lon longitude
     */
    static void exec(double lat, double lon, float bearing, float speed) {
        if (mockNetwork != null) {
            try {
                mockNetwork.pushLocation(lat, lon, bearing, speed);
            }
            catch (Exception e) {
             // stopMockingLocationNetwork();
            }
        ...
        if (mockGps != null) {
            try {
                mockGps.pushLocation(lat, lon, bearing, speed);
            }
            catch (Exception e) {
             // stopMockingLocationGps();
            }
